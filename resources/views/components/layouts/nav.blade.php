<nav class="lg:h-nav bg-nav flex flex-col lg:flex-row justify-center lg:justify-end items-stretch lg:items-center border-t border-boton-secondary p-2 lg:space-x-5">
    <a href="{{route("alumnos")}}" class="hidden lg:block w-full lg:w-auto"><button class="btn btn-md shadow-none bg-boton-primary border-transparent hover:bg-boton-secondary lg:w-30 lg:h-10 w-full my-0.5">{{__("Alumnos")}}</button></a>
    <a href="{{route("profesores")}}" class="hidden lg:block w-full lg:w-auto"><button class="btn btn-md shadow-none bg-boton-primary border-transparent hover:bg-boton-secondary lg:w-30 lg:h-10 w-full my-0.5">{{__("Profesores")}}</button></a>
